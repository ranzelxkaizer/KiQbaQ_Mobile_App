...
const FeedbackResponsesDetailScreen: React.FC = () => {
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <View style={[styles.header, { backgroundColor: "#4A90D9" }]}>
        ...
        <Text style={styles.headerTitle}>Feedback Responses Detail</Text>
      ...
      <ScrollView style={styles.content}>
        ...
        >
          <View style={styles.pageHeaderContent}>
            ...
            <View style={styles.pageHeaderText}>
              <Text style={styles.pageHeaderTitle}>Feedback Responses</Text>
              <Text style={styles.pageHeaderSubtitle}>
                Customer feedback and survey responses from demonstrations
              </Text>
            </View>
          </View>
        </View>
        ...
        >
          <View style={styles.emptyState}>
            ...
            >
              No feedback responses have been collected in this period.
            </Text>
          </View>
        </View>
      </ScrollView>
...
export default FeedbackResponsesDetailScreen;
